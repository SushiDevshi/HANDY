...
namespace Servos.Weapon
{
    public class PAIN : BaseState
    {
        ...
        public override void OnEnter()
        {
            ...
            if (base.isAuthority)
            {
                this.duration = PAIN.baseDuration / this.attackSpeedStat;
                ...
                this.attack.hitEffectPrefab = PAIN.hitEffectPrefab;
                ...
                if (base.GetComponent<ServosOverclockController>().overclockOn && Util.CheckRoll(30, base.characterBody.master) && base.isAuthority)
                {
                    this.attack.damageType = DamageType.PercentIgniteOnHit;
                }
